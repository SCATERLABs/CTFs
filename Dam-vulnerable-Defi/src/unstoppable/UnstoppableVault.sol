    ...
    Pausable
{
    ...
    uint64 public immutable end = uint64(block.timestamp) + GRACE_PERIOD; //time period to return the flashlOan
    ...
    function totalAssets()
        ...
        returns (uint256)
    {
        return asset.balanceOf(address(this)); //address of this contract
    }
