...
contract BankVaults is IERC4626 {
    //immutable asset token
    // This contract allows users to stake ETH and receive vault tokens in return.
    ...
    // Vault token balances for each staker
...
//@why what is the use of initial supply? 
...
//here we are updating the vault token balance of the receiver but instead of shares use assets 
    ...
    function withdraw(uint256 assets, address receiver, address owner) public override onlyStaker returns (uint256 shares) {
        ...
        //what is the use of this yield ,what is yield?
        // Yield is calculated as a percentage of the assets withdrawn.
        // In this case, it's 1% of the assets.
    ...
    function flashLoan(uint256 amount, address receiver, uint256 timelock) public {
        ...
        //here not checking ,the msg.sender is >=0 ,1 ether is ok
